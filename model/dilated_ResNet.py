"""
该模型的思路是，转化为192*192=36864多分类问题
之后可以reshape为(192,192)的矩阵，与label的交叉熵作为loss
"""
...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=192*192,
...
if __name__ == '__main__':
    model2 = DRN(Bottleneck, [1, 1, 3, 4, 6, 3, 1, 1],
